...
public class IceSpikeSkill01 : SkillControl
{
    Vector3 pos;
    public float sizeX;
    public float sizeY;
    ...
    public override void SkillStart()
    {
        ...
        if (skillTimer <= 0)
        {
            IceSpike skillobj = Instantiate(skill, pos, skillPos.transform.rotation * skill.transform.rotation).GetComponent<IceSpike>();
